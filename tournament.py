...
GROUPS_FILE = os.path.join(os.path.dirname(__file__), "data", "wc2026_groups.json")
CACHE_STATS = os.path.join(os.path.dirname(__file__), "data", "team_stats.json")
...
def load_team_db() -> dict:
    ...
    elos_file = os.path.join(os.path.dirname(__file__), "data", "elos.json")
    try:
...
def main():
    ...
    # Guardar resultados
    out_path = os.path.join(os.path.dirname(__file__), "data", "mc_results.json")
